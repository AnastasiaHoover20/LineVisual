...
<<<<<<< HEAD
  coords[2] = new PVector(int (random(x,x+w)), int (random(y,y+h))); //decide how we are determining start and end (make 2 variables begin and end) (x1 y1)
  coords[3] = new PVector(int (random(x,x+w)), int (random(y,y+h)));
  coords[4] = new PVector(int (random(x,x+w)), int (random(y,y+h)));
=======
